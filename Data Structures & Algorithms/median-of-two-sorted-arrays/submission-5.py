class Solution:
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        ...
        while low<=high:
            ...
            r1 = nums1[mid1] if mid1<n1 else 10^6+1                
            r2 = nums2[mid2] if mid2<n2 else 10^6+1
            l1 = nums1[mid1-1] if mid1-1>=0 else -10^6-1                
            l2 = nums2[mid2-1] if mid2-1>=0 else -10^6-1
